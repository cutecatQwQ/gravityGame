...
public class ScrollBar extends BoxAndTextModel{
    ...
    public ScrollBar(double x, double y, double w, double h, int size, double per, double min, double max, Color color, Color textColor ,Color fontColor,Color buttonColor) {
