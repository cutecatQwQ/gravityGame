...
import gameEngine.gameStart.testOne.Graph;
import gameEngine.gameStart.testOne.Line;
import gameEngine.gameStart.testOne.Point;
import gameEngine.mainFrame.model.ImageModel;
import gameEngine.Tool.Tool;
import gameEngine.gameStart.gravity.GravityInit;
import gameEngine.gameStart.multiDimensional.MultiDimensionalInit;
import gameEngine.mainFrame.MainJFrame;
import gameEngine.mainFrame.model.BoxAndTextModel;
import gameEngine.mainFrame.mouseAndKeyLister.*;
...
//        test8(mainJFrame);
    ...
    private void test8(MainJFrame mainJFrame) {
        ...
        gameEngine.gameStart.testOne.Point startX = new gameEngine.gameStart.testOne.Point(0, MainJFrame.dimension.height / 2.0, 1, Color.red, 0);
        gameEngine.gameStart.testOne.Point endX = new gameEngine.gameStart.testOne.Point(MainJFrame.dimension.width, MainJFrame.dimension.height / 2.0, 1, Color.red, 0);
        graph.addLine(startX, endX, mainJFrame);
        gameEngine.gameStart.testOne.Point startY = new gameEngine.gameStart.testOne.Point(MainJFrame.dimension.width / 2.0, 0, 1, Color.red, 0);
        gameEngine.gameStart.testOne.Point endY = new gameEngine.gameStart.testOne.Point(MainJFrame.dimension.width / 2.0, MainJFrame.dimension.height, 1, Color.red, 0);
        graph.addLine(startY, endY, mainJFrame);
        //y = e^x
        int length = MainJFrame.dimension.width;
        gameEngine.gameStart.testOne.Point[] points = new gameEngine.gameStart.testOne.Point[length];
        ...
        for (int i = 0; i < length; i++) {
            points[i] = new gameEngine.gameStart.testOne.Point(x[i] + MainJFrame.dimension.width / 2.0, MainJFrame.dimension.height / 2.0 - y[i], 1, Color.red, 0);
            if (i != 0) {
    ...
    public static gameEngine.gameStart.testOne.Point background = new gameEngine.gameStart.testOne.Point(0, 0, 20, Color.red, 0) {
        @Override
        public void paint() {
            super.paint();
    ...
    private void test2(MainJFrame mainJFrame) {
        Random random = new Random();
        Graph graph = new Graph();
        gameEngine.gameStart.testOne.Point[] points = new gameEngine.gameStart.testOne.Point[16];
        for (int i = 0; i < points.length; i++) {
//            points[i] = new Point(10, 10, 5,Color.red,0);
            points[i] = new gameEngine.gameStart.testOne.Point(random.nextInt(1500) + 10, random.nextInt(800) + 10, 10, Color.red, 0);
...
//        }
    ...
    private void test1(MainJFrame mainJFrame) {
        gameEngine.gameStart.testOne.Point model = new gameEngine.gameStart.testOne.Point(1000, 100, 10, Color.black, -2) {
            @Override
            public void paint() {
                super.paint();
                Graphics2D g = getGraphics2D();
        ...
        gameEngine.gameStart.testOne.Point point1 = new gameEngine.gameStart.testOne.Point(1000, 100, 5, Color.black, -1);

        gameEngine.gameStart.testOne.Point point = new Point(1200, 200, 5, Color.black, -1);
