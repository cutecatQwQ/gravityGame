package gameEngine.mainFrame;

import gameEngine.mainFrame.Service.PaintService;
import gameEngine.Tool.Tool;
import gameEngine.mainFrame.Service.ListenerService;
...
public class MainJFrame extends JFrame {
    ...
    private void paintRun() {
        //相比于while绘制出来更加稳定，不会因为某次计算延迟而卡顿
...
//        }
    ...
    private void initAndStart() {
        ...
        //启动绘画线程
        new Thread(this::paintRun,"Paint-Thread").start();
    }
